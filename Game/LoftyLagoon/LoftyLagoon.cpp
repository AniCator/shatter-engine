...
void CGameLoftyLagoon::Tick()
{
	...
	for( int i = 0; i < 250; i++ )
	{
		...
		RenderData.Position = glm::vec3( RandomOffsetX, RandomOffsetY, glm::abs( glm::sin( CurrentTime * 3.0f + RandomOffsetX * 0.002f ) ) * glm::abs( glm::cos( CurrentTime * 3.0f + RandomOffsetY * 0.002f ) ) * 500.0f );
